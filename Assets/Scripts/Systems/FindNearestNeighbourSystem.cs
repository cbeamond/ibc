...
{
	public class FindNearestNeighbourSystem : MonoBehaviour
	{
		...
		private Dictionary<int, FindNearestNeighbour> nearestNeighbours;
		...
		[HideInInspector]
		public static FindNearestNeighbourSystem Instance;
		...
		private void Awake()
		{
			...
			if (Instance)
				throw new InvalidOperationException($"A singleton already exists for {typeof(FindNearestNeighbourSystem).Name}");

			Instance = this;
		}

		public void AddNeighbour(FindNearestNeighbour neighbour)
		{
			nearestNeighbours[neighbour.GetInstanceID()] = neighbour;
		}

		public void RemoveNeighbour(FindNearestNeighbour neighbour)
		{
			nearestNeighbours.Remove(neighbour.GetInstanceID());
		}
		public FindNearestNeighbour GetNearestNeighbour(FindNearestNeighbour neighbour)
		{
			if (nearestNeighbours.TryGetValue(neighbour.GetInstanceID(), out FindNearestNeighbour closestNeighbour))
